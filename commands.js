...
class commands {
    ...
    async about(message) {
        const aboutembed = new discord.MessageEmbed()
         ...
         .setImage('https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/lineboi.png') // Change of plans, square looks ugly. OLD (https://cdn.hornyfur.com/rmCo.png)
         .setFooter('The Retriever developer team, Phoenix#2432 and Magik Manz#9999', 'https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/fetcherlogo.png') // Upload picture for footer ASAP. =) OLD (https://cdn.hornyfur.com/gjeQ.png)
    ...
    async help(message) {
        const helpembed = new discord.MessageEmbed()
            ...
            .setFooter('Have any suggestions? Contact us via email! admin@gsheps.net', 'https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/fetcherlogo.png')
    ...
    async zoomies(message) {
       const zoomiesembed = new discord.MessageEmbed()
        ...
        .setImage('https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/zoomies.gif') // OLD (https://cdn.hornyfur.com/6vDf.gif)
    ...
    async bananaphone(message) {
        const bananaphoneembed = new discord.MessageEmbed()
            ...
            .setImage('https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/BananaPhone.gif') // Stupid discord limitations, can't put videos :( OLD (https://cdn.hornyfur.com/iEBD.gif)
    ...
    async brokendog(message) {
        const brokendogembed = new discord.MessageEmbed()
            ...
            .setImage('https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/brokendog.gif') // OLD (https://cdn.hornyfur.com/WtJQ.gif)
    ...
    async sowwy(message) {
        const sowwyembed = new discord.MessageEmbed()
            ...
            .setImage('https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/sowwy.gif') // OLD (https://cdn.hornyfur.com/GxBj.gif)
    ...
    async what(message) {
        const dowhatembed = new discord.MessageEmbed()
            ...
            .setImage('https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/what.gif')  // OLD (https://cdn.hornyfur.com/5wtn.gif)
    ...
    async pupachino(message) {
        const pupachinoembed = new discord.MessageEmbed()
            ...
            .setImage('https://github.com/Phoenix-Net/Retriever-Assets/blob/master/assets/pupachino.gif')
